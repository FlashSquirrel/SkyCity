	...
	<form method="post" action="<?=$_extend_url;?>&pmod=user&op=add">
	    <table class="table-font"><tbody>
	        ...
	        <tr>
	            ...
	            <td>
	            	<input type="text" class="textinput w270" name="user_field[contact]" value="<?=$seller['contact'];?>">
	            </td>
	        </tr>
	        <tr>
	            <th>店铺名：</th>
	            <td><input type="text" class="textinput w270" name="user_field[shop]" value="<?=$seller['shop'];?>"></td>
	        </tr>
	        <tr>
	            <th class="w120">邮箱：</th>
	        ...
	        <tr>
	            <th>旺旺：</th>
	            <td><input type="text" class="textinput w270" name="user_field[wangwang]" value="<?=$seller['wangwang'];?>"></td>
	        </tr>
	        <tr>
	            <th>支付宝：</th>
	        ...
	        <tr>
	            <th>店铺简介：</th>
	            <td><input type="text" class="textinput w270" name="user_field[introduce]" value="<?=$seller['introduce'];?>"></td>
	        </tr>
	    </tbody></table>
		<div class="box-footer">
		    <div class="box-footer-inner">
