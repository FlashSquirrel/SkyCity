	        ...
	        <tr style="<?php if(intval($activity['pay'])==0){ ?>display:none<?php } ?>">
	            ...
	            <td>
	            	...
	            	<p style="margin-bottom: 5px;">
		            	<input type="text" class="textinput" disabled="true" name="activity[paydetail][title][]" value="" placeholder="如:首页三天">&nbsp;
		            	<input type="text" class="textinput w60" disabled="true" name="activity[paydetail][money][]" value="">&nbsp;元
	            	</p>
	            	<?php }else{ ?>
		            	<?php foreach ($activity['paydetail']['title'] as $k=>$val){ ?>
		            		<p style="margin-bottom: 5px;">
				            	<input type="text" class="textinput" disabled="true" name="activity[paydetail][title][]" value="<?=$val;?>" placeholder="如:首页三天">&nbsp;
				            	<input type="text" class="textinput w60" disabled="true" name="activity[paydetail][money][]" value="<?=$activity['paydetail']['money'][$k];?>">&nbsp;元
			            	</p>
		            	<?php } ?>
	            	<?php } ?>
