...
<?php if($op=='index'){ ?>
		...
		<dl>
			...
			<dd>
			  <textarea class="fl">我爱上了<?=$_webset['site_name'];?>懂我的商品，懂我的价格，真的要跟你八卦一下才行。<?=$inviteurl;?></textarea>
			  <span class="fl">
			  	<div class="fuzhi">
			 	...
			 	<object type="application/x-shockwave-flash" data="static/flash/clipboard.swf" id="clipboard" 
					...
					<param name="flashvars" value="content=我爱上了<?=$_webset['site_name'];?>懂我的商品，懂我的价格，真的要跟你八卦一下才行。<?=$inviteurl;?>">
			    </object>					    
			  </span>
			</dd>
			<dd class="no_change">
