...
-- --------------------------------------------------------
DROP TABLE IF EXISTS pre_seller_activity;
CREATE TABLE pre_seller_activity (
...
-- --------------------------------------------------------
DROP TABLE IF EXISTS pre_seller_changelog;
CREATE TABLE pre_seller_changelog (
...
-- --------------------------------------------------------
DROP TABLE IF EXISTS pre_seller_guide;
CREATE TABLE pre_seller_guide (
...
-- --------------------------------------------------------
DROP TABLE IF EXISTS pre_users_seller_fields;
CREATE TABLE pre_users_seller_fields (
  `uid` int(10) unsigned NOT NULL,
...
-- --------------------------------------------------------
DROP TABLE IF EXISTS pre_users_seller_session;
CREATE TABLE pre_users_seller_session (
  `uid` int(10) NOT NULL,
  `user_name` varchar(20) NOT NULL,
  `email` varchar(50) NOT NULL,
  `mobile` char(11) NOT NULL,
...
-- --------------------------------------------------------
DROP TABLE IF EXISTS pre_special_position;
CREATE TABLE pre_special_position (
...
-- --------------------------------------------------------
DROP TABLE IF EXISTS pre_android_ad;
CREATE TABLE pre_android_ad (
  `aid` smallint(3) NOT NULL AUTO_INCREMENT,
...
-- --------------------------------------------------------
DROP TABLE IF EXISTS pre_android_app;
CREATE TABLE pre_android_app (
  `aid` smallint(3) NOT NULL AUTO_INCREMENT,
  `title` char(20) NOT NULL,
...
-- --------------------------------------------------------
DROP TABLE IF EXISTS pre_android_nav;
CREATE TABLE pre_android_nav (
